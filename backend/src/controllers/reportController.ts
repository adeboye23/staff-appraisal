...
export const userReport = asyncHandler(async (req: AuthedRequest, res: Response) => {
...
export const departmentReport = asyncHandler(async (req: AuthedRequest, res: Response) => {
...
export const organizationReport = asyncHandler(async (_req: AuthedRequest, res: Response) => {
