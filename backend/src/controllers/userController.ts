...
export const listStaffInvitations = asyncHandler(async (_req: AuthedRequest, res: Response) => {
  const invitations = await listInvitations();
  res.json({ data: invitations });
});

export const resendStaffInvitation = asyncHandler(async (req: AuthedRequest, res: Response) => {
...
export const revokeStaffInvitation = asyncHandler(async (req: AuthedRequest, res: Response) => {
  const invitationId = Number(req.params.id);
...
export const updateStaffStatus = asyncHandler(async (req: AuthedRequest, res: Response) => {
  const userId = Number(req.params.id);
  await ensureCanManageTargetUser(req.user?.role, userId);
